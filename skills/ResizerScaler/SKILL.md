...
summary: >
  Adjusts aspect ratios, scales resolutions, pads canvas dimensions, and reframes image/video/GIF assets.
  Supports cover, contain, stretch, and manual fit modes, anchoring, solid/gradient fills, and blurred smart backgrounds.
triggers:
  - resize
  - scale
  - aspect ratio
