...
nodeType: VideoGen
summary: >
  Generates AI videos from text prompts and optional reference inputs (Images, Videos, or Audio) using advanced models like Wan 2.7 and Seedance 2.0.
  Supports customized resolution, aspect ratios, seeds, and durations.
triggers:
  - video generator
  - generate video
  - text to video
