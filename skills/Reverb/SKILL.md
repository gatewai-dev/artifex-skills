...
nodeType: Reverb
summary: >
  Adds room ambience, acoustic space, and reverberation to audio tracks.
  Implements the standard algorithmic Freeverb model using a cascade of comb and allpass filters in a WebGPU compute shader.
triggers:
  - reverb
  - audio reverb
  - freeverb
