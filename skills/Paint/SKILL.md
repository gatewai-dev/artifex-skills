...
nodeType: Paint
summary: >
  A canvas drawing tool that lets you paint brush strokes, erase, and draw custom masks over any media.
  Outputs the composited result and a standalone monochrome mask for downstream masking/effects.
triggers:
  - paint
  - draw
  - sketch
