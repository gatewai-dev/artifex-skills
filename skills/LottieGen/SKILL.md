...
nodeType: LottieGen
summary: >
  Generates or edits interactive vector animations (Lottie format) based on a text prompt using an LLM.
  Configurable canvas size, duration, frame rate, and model selection.
triggers:
  - lottie
  - lottie generator
  - generate animation
