...
nodeType: Levels
summary: >
  Adjusts the tonal range and color balance of images, videos, GIFs, SVGs, and Lottie files.
  Features channel-specific controls (Master, Red, Green, Blue) with input/output black and white points to adjust contrast, brightness, and color tinting.
triggers:
  - levels
  - color correction
  - color grading
