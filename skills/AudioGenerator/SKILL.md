...
summary: >
  Generates audio, sound effects, or speech using the AI audio generator model.
  Supports reference images or reference audio clips, speed, volume, and pitch controls.
triggers:
  - audio generator
  - generate audio
  - text to audio
