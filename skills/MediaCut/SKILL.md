...
nodeType: MediaCut
summary: >
  Cuts, trims, or stitches video, audio, Lottie, or GIF files by specifying one or more start and end times in seconds.
  Supports extracting multiple non-contiguous segments and joining them together.
triggers:
  - cut
  - trim
  - split
