...
nodeType: Upscaler
summary: >
  Upscales and enhances image or video assets using Fal.ai SeedVR models.
  Automatically routes to the image or video model based on the connected input type.
  Supports factor-based scaling (1× – 4×) and fixed resolution targets (720p, 1080p, 1440p, 2160p).
triggers:
  - upscale image
  - upscale video
  - enhance resolution
