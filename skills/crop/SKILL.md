---
name: crop
description: "Crops media files using rectangular or path-based masks. Produces two outputs: the cropped region and the remaining uncropped region. Supports rounded corners and customized point-by-point path structures."
metadata:
  nodeType: Crop
  triggers: "crop, mask, slice, trim image, cut media, rounded corners, path crop"
---
