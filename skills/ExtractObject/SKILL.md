...
summary: >
  Extracts specific objects from an image using natural language prompt descriptions.
  Returns the extracted object on a transparent background and the corresponding segmentation mask.
triggers:
  - extract object
  - object extraction
  - segment object
