...
summary: >
  Generates text captions (subtitles/transcriptions) for audio and video media using AI
  (specifically Whisper via Fal AI). Output is generated in SRT format. Supports customized prompts,
  language selection, batch sizing, and segment-level or word-level transcription chunks.
triggers:
  - caption
  - transcription
  - subtitle
