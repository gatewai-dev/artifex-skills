---
name: stereo-panning
description: "Adjusts the left/right stereo balance (panning) of audio or video tracks. Supports panning values from -1 (full left) to 1 (full right)."
metadata:
  nodeType: StereoPanning
  triggers: "stereo panning, pan audio, audio balance, left right channel, stereo sound, audio spatialization"
---
