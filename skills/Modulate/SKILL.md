...
nodeType: Modulate
summary: >
  Applies color modulation adjustments (Hue, Brightness, Contrast, Exposure, Saturation, Sepia)
  to images, videos, GIFs, SVGs, and Lottie animations. Supports binding parameters to dynamic signals.
triggers:
  - modulate
  - color adjustments
  - hue rotation
