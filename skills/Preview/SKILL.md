...
nodeType: Preview
summary: >
  A utility node that displays a real-time visualization of any connected media, text, or signal input.
  Helps debug intermediary workflow states without modifying assets.
triggers:
  - preview
  - inspect
  - view output
