...
summary: >
  Generates high-quality music/audio tracks from a text prompt and optional lyrics using AI music models.
  Supports settings for instrumental music, sample rates, and bitrates (fixed to MP3 format).
triggers:
  - music generator
  - generate music
  - text to music
