...
nodeType: MeshWarp
summary: >
  Warps images, videos, GIFs, SVGs, and Lottie animations using a grid of control points.
  Configure columns, rows, and coordinate offsets to mold and distort media in real time.
triggers:
  - mesh warp
  - grid warp
  - elastic warp
