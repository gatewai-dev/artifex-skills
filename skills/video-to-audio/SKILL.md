---
name: video-to-audio
description: "Converts a video track to an audio track. On the browser frontend, it hides the visual frames, and on the backend renderer, it decodes and processes only the audio track."
metadata:
  nodeType: VideoToAudio
  triggers: "video to audio, convert video to audio, extract audio from video, video sound track, hide video frames"
---
