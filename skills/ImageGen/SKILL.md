...
nodeType: ImageGen
summary: >
  Generates new images or edits existing images using AI models (OpenAI DALL-E, Flux 2 Pro, or Nano Banana 2 via Fal AI).
  Supports custom dimensions, safety checkers, quality levels, transparency, and image-to-image editing/inpainting.
triggers:
  - image gen
  - generate image
  - text to image
