---
name: text
description: "Provides a text block input node on the canvas. Outputs a Text string that can be connected to prompt, caption, lyric, or instructions inputs of downstream nodes."
metadata:
  nodeType: Text
  triggers: "text, string, prompt, input text, text input, description, words"
---
