...
nodeType: Compositor
summary: >
  Composes multiple media layers (Text, Image, SVG, Audio, Caption, Video, GIF, and Lottie)
  into a single image or video file. Supports layer positioning, timing, opacity, blending,
  animations, volume, transitions, and timeline segments.
triggers:
  - compositor
  - composite
  - layer
