...
summary: >
  Extracts a single frame from a Video, Lottie animation, or GIF and outputs it as a static Image.
  The user selects the frame number and the extraction is performed on the GPU as a virtual process.
triggers:
  - extract frame
  - frame capture
  - screenshot
