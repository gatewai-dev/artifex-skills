...
description: "Distorts media using a displacement map texture for liquid, ripple, glitch, and organic warp effects using WebGPU shaders."
metadata:
  nodeType: DisplacementMap
  triggers: "displacement map, warp, distort, glitch effect, liquid ripple, displacement"
---
