...
summary: >
  Synthesizes human-like spoken audio from a text input prompt using the Gemini TTS model via Fal AI.
  Supports customizable voice profiles, multiple languages, and stylistic instructions.
triggers:
  - text to speech
  - speech synthesis
  - tts
