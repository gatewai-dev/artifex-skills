...
nodeType: ApplyLUT
summary: >
  Applies a 3D Color Lookup Table (.cube LUT file) to input media (Image, SVG, Video, Lottie, or GIF).
  Supports adjusting the application intensity using static numbers or dynamic modulators/signals.
triggers:
  - apply lut
  - color grading
  - lut
