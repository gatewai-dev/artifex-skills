---
name: First to last frame video
nodeType: VideoGenFirstLastFrame
summary: >
  Generates AI videos that interpolate smoothly between a required first-frame image and a last-frame image.
  Ideal for creating controlled transitions, loops, morphs, or animated storytelling clips.
triggers:
