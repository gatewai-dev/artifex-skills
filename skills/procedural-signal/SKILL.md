...
description: "Generates custom mathematical/procedural signals using WGSL (WebGPU Shading Language) equations. Supports configurable amplitude, frequency, phase, offsets, custom uniform parameters, and multiple preview modes."
metadata:
  nodeType: ProceduralSignal
  triggers: "procedural signal, math signal, wave generator, sine wave, cosine wave, wgsl function, oscillator, modulation signal, noise function"
---
