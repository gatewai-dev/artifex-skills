...
nodeType: ExtractLUT
summary: >
  Extracts a 3D Color Lookup Table (.cube LUT) by comparing a source image against a graded reference image.
  Supports deterministic RBF fitting and statistical Reinhard LAB color matching strategies.
triggers:
  - extract lut
  - match color
  - color transfer
