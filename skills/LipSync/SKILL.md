...
nodeType: LipSync
summary: >
  Animates a static avatar image into a talking head video synced to a target audio speech track.
  Powered by AI models (Creatify Aurora or ByteDance OmniHuman via Fal AI).
triggers:
  - lip sync
  - talking avatar
  - talking head
