...
summary: >
  Generates procedural particles and visual effects (smoke, fire, rain, snow, dust, sparks,
  lightning, magic, lens flares, embers, energy beams) from scratch as an image or video layer.
triggers:
  - procedural vfx
  - particle generator
  - smoke
