...
nodeType: Export
summary: >
  The terminal workflow node that compiles and renders composition outputs.
  Allows exporting results in MP4, WebM, GIF, MP3, or CUBE (LUT) formats with configurable render targets.
triggers:
  - export
  - download
  - save
