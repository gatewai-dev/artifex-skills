...
nodeType: Number
summary: >
  Provides a numeric value input node on the canvas. Outputs a Number datatype that can
  be connected to input handles of other nodes accepting numeric values.
triggers:
  - number
  - value
  - float
