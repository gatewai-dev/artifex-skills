---
name: caption-editor
description: "Provides a manual caption editor on the canvas. Stores SRT formatted text in its config and outputs a Caption format for subtitle tracks."
metadata:
  nodeType: CaptionEditor
  triggers: "captions, subtitles, srt, create captions, caption editor, subtitle creator"
---
