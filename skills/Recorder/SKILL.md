...
nodeType: Recorder
summary: >
  Records media directly from the web browser, supporting screen capture, camera feed,
  and microphone audio. Outputs separate Video and Audio handles for downstream compositing.
triggers:
  - recorder
  - record screen
  - capture camera
