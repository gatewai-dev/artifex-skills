...
nodeType: Note
summary: >
  A visual sticky note utility for the node canvas. Allows editors and builders to document
  workflows, add comments, leave instructions, and customize note appearance.
triggers:
  - sticky note
  - note
  - documentation
