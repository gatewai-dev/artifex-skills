---
name: htmlvideo-gen
description: "Generates seekable HTML/CSS/GSAP animations using AI based on user text prompts and optional reference media (Images, Videos, SVGs, Captions, and Lottie animations). Ideal for custom CSS animations, product demos, dynamic text slides, and interactive visual effects."
metadata:
  nodeType: HTMLVideoGen
  triggers: "html video generator, html animation, gsap video, code animation, web animation, generate html video, threejs animation, threejs video, webgl animation, chart animation, render chart, 3d chart animation"
---
