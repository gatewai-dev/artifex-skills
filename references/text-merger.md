---
name: text-merger
description: "Concatenates multiple text inputs into a single combined text output using a customizable join separator. Uses variable inputs to support merging any number of text handles."
metadata:
  nodeType: TextMerger
  triggers: "text merger, merge text, concat text, concatenate, join string, string merger, append text"
---
